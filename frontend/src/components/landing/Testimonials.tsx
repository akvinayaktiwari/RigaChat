  ...
  const mainReviews = [
    {
      id: 'review1',
      quote:
        "Most of our chats are sales-related, and we've seen a significant uptick in sales since implementing BeepBoop.",
      author: 'Milena Wojewoda',
      role: 'Digital Project Specialist, Sephora',
      avatar:
        'https://lh3.googleusercontent.com/aida/AP1WRLvJbkQPBp6bUjUE6lptZEFzgTW8BTcIrOjd0wHKHEzYX26ORkXkvMK_b2qpo48lZzjugLXvi2dCXEO-UzwEMIK8ZyhkK3RY0J_g2S4W-XaCvSYMCwQ17zmYdpJDQ0AIbzt6fUZLXrCuR5UHXsPjiGs2DTr8EP96t02ku8zW5izgj55D09K1OUZfkeYyMdv1NYUZTd5NvDbm-WSTN7TfwQqmURgCuDCb4xKw9iFV6oma1aVPkSxkgDaYOuY',
    },
    {
      id: 'review2',
      ...
      avatar:
        'https://lh3.googleusercontent.com/aida/AP1WRLtLROCaq1wg9QmAHQzawDiq-geOeX6ObPREtjTUf26vcxSdHtjKShIIrqfwNk3mjEMclWEis5E2LJSYrxVZDZKSuPvMVUNmkPZOzUv2aS0aMuwqUMihw7KsUCnUZSHYd6YKkAi2blNOmEljk_dmAu1x6ndgbYoRAl3bq51J8WRsdRelNCGS-MUhQ-n7CYbvXil-FObKvE_zuaa8vED38Me6j1llwGEN5bdz-MJ56Qn783gHWRd79-S5_A',
    },
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-on-surface-variant max-w-2xl mx-auto">
            Don&apos;t just take our word for it. Join thousands of businesses that have transformed their sales
            process.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {mainReviews.map((review) => (
            <motion.div
              key={review.id}
              whileHover={{ y: -6 }}
              className="landing-glass-card p-8 md:p-10 rounded-3xl flex flex-col justify-between border border-outline-variant/30 relative"
            ...
            >
              <div>
                ...
                {/* Quote */}
                <p className="text-xl md:text-2xl font-bold leading-relaxed text-on-background">"{review.quote}"</p>
              </div>
