...
const BENEFIT_CARDS: BenefitCard[] = [
  ...
  { icon: <TrendingUp className="w-5 h-5" />, title: 'Equity Potential', body: 'Early team members get equity as Vyostra AI grows.' },
    ...
    <section className="relative py-16 md:py-24 bg-gradient-to-br from-surface-container-high/60 via-surface to-background border-b border-outline-variant/30 rounded-3xl mb-16 overflow-hidden px-6 md:px-12 text-center">
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <p className="mt-4 text-base md:text-lg text-on-surface-variant leading-relaxed max-w-2xl mx-auto">
          Vyostra AI is a fully remote team building AI products that help businesses capture and convert leads. We move fast, build lean, and care about craft.
        </p>
        <a
  ...
  return (
    <section className="max-w-7xl mx-auto bg-on-surface rounded-3xl p-10 text-center text-white">
      ...
      <p className="text-white/80 max-w-xl mx-auto mb-8 leading-relaxed">
        We always want to hear from talented people. Send us your resume and tell us how you would contribute to Vyostra AI.
      </p>
      <a
        href="mailto:support@vyostra.com?subject=Resume — Vyostra AI Application"
