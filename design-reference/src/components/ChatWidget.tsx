...
import { MessageSquare, X, Send, Sparkles, Check, Gift } from "lucide-react";
...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      sender: "bot",
      text: "Welcome to RigaChat! 👋 I'm RigaBot, your AI-powered growth assistant. How can I help you turn your traffic into revenue today?",
      time: "Just now"
    }
  ]);
  ...
  const triggerBotResponse = (userText: string) => {
    ...
    let reply = "I'm not fully sure about that, but our team of product specialists is ready to help! Would you like to schedule a quick 10-minute demo?";
    
    if (userText.includes("feature") || userText.includes("core") || userText.includes("do") || userText.includes("how")) {
      reply = "RigaChat provides state-of-the-art live chat with real-time visitor tracking, automated lead categorization, and proactive AI RigaBots that engage visitors with personalized triggers to increase conversion by 30%.";
    } else if (userText.includes("pricing") || userText.includes("cost") || userText.includes("plan")) {
      reply = "RigaChat starts with a 14-day free trial. Premium plans start at just $29/month with unlimited chats, full AI capability, CRM integrations, and premium custom dashboard widgets!";
    } else if (userText.includes("agent") || userText.includes("sales") || userText.includes("human")) {
      reply = "Sure! Let me forward you to our Sales Lead. Since our live agents are currently supporting other inquiries, please leave your email so they can reach out in under 10 minutes!";
    } else if (userText.includes("trial") || userText.includes("free") || userText.includes("signup")) {
      reply = "Yes! We offer a full 14-day trial of our top tier package. No credit card is required, and setup assistance is entirely free. Tap 'Sign up free' on the landing page to get started right away!";
    }
        ...
        {isOpen && (
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm leading-tight flex items-center gap-1">
                    RigaBot <Sparkles className="w-3.5 h-3.5 text-yellow-300" />
                  </h4>
            ...
            >
              <input
                type="text"
                placeholder="Ask RigaBot anything..."
                value={inputValue}
