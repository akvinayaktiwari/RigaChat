...
export default function Navbar({ onOpenTrial, onOpenDemo }: NavbarProps) {
        ...
        <div className="flex items-center justify-between px-6 lg:px-8 max-w-7xl mx-auto h-full">
          ...
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="#cta" className="text-sm font-semibold text-on-surface-variant hover:text-primary transition-colors py-1.5" id="nav-link-resources">
                Integrations
              </a>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button
              onClick={onOpenTrial}
              className="cta-accent text-white text-sm font-semibold px-5 py-3 rounded-xl transition-all hover:shadow-[0_4px_20px_rgba(37,99,235,0.25)] hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
          ...
          <>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  Sign up free <ArrowRight className="w-4.5 h-4.5" />
                </button>
              </div>
            </motion.div>
          </>
