...
export default function Hero({ onOpenTrial, onOpenDemo }: HeroProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-on-background tracking-tight leading-[1.1]">
            The AI-Powered CRM that turns conversations into{" "}
          ...
          <p className="text-lg md:text-xl text-on-surface-variant max-w-xl leading-relaxed">
            Deploy intelligent bots in minutes, capture more leads, and automate your customer support with RigaChat.
          </p>
        ...
        >
          ...
          <div className="glass-card rounded-2xl overflow-hidden shadow-2xl relative border border-outline-variant/40">
            {/* Browser top-bar */}
            ...
            <div className="aspect-[16/10] bg-surface-container-low flex items-center justify-center overflow-hidden">
              <img
                ...
                alt="RigaChat Intelligent Customer Operations Center Dashboard"
