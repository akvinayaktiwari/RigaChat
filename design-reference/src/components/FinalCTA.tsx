...
export default function FinalCTA({ onOpenTrial }: FinalCTAProps) {
  ...
  return (
    <section className="py-24 bg-inverse-surface text-inverse-on-surface relative overflow-hidden" id="cta">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center relative z-10 flex flex-col items-center">
        ...
        {/* Heading */}
        <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-8 max-w-3xl leading-tight">
          Ready to increase sales and enjoy seamless automation?
        </h2>
        ...
        <div className="flex flex-col items-center gap-5">
          <button
            onClick={onOpenTrial}
            className="cta-accent text-white font-extrabold text-lg md:text-xl px-12 py-5.5 rounded-2xl transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_50px_rgba(37,99,235,0.45)] cursor-pointer"
            id="cta-signup-btn"
          >
            Sign up free
          </button>
